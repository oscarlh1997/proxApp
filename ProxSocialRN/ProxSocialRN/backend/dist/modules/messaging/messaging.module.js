...
const messaging_controller_1 = require("./infrastructure/controllers/messaging.controller");
const chat_gateway_1 = require("./infrastructure/gateways/chat.gateway");
...
exports.MessagingModule = MessagingModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([messaging_entities_1.ConversationEntity, messaging_entities_1.ConversationMemberEntity, messaging_entities_1.MessageEntity]),
